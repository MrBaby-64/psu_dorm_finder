                    ...
                    <div>
                        ...
                        @if($request->property)
                            <div class="space-y-2">
                                ...
                                @if($request->property->images->count() > 0)
                                <div class="mt-3">
                                    <img src="{{ asset('storage/' . $request->property->images->first()->image_path) }}"
                                         alt="Property Image"
                                ...
                                <div class="mt-3">
                                    <a href="{{ route('properties.show', $request->property) }}"
                                       target="_blank"
                ...
                <div class="bg-white rounded-lg p-6 max-w-lg w-full mx-4">
                    ...
                    <div class="bg-yellow-50 border border-yellow-200 rounded-md p-4 mb-4">
                        <p class="text-sm text-yellow-800">
                            ...
                            "{{ $request->property->title }}" and all associated data (images, rooms, bookings, etc.).
                        </p>
                    </div>
