...
@section('title', 'Admin Dashboard - System Error')
...
<div class="bg-white shadow-md rounded-lg p-6">
    <div class="text-center">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
            ...
            <a href="/system-check" target="_blank"
        ...
        <div class="mt-6 text-sm text-gray-500">
            <p>Admin functions may still work individually even if dashboard statistics fail to load.</p>
        </div>
    </div>
</div>
@endsection