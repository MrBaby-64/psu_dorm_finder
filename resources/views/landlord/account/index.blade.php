...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-lg shadow p-6 text-white">
        <div class="flex items-center justify-between">
            <div>
                <h3 class="text-xl font-bold mb-2">Want to post your property?</h3>
                <p class="text-green-100">Add your listing to PSU Dorm Finder's catalog</p>
            </div>
            <a href="{{ route('landlord.properties.create') }}" class="bg-white text-green-600 px-6 py-3 rounded-lg font-semibold hover:bg-green-50">
                Post Property
            </a>
        </div>
    </div>
