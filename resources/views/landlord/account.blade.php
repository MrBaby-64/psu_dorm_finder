...
(function() {
    const dashboardUrl = window.location.origin + '/landlord/account';
    ...
    if (isFreshLogin) {
        ...
        sessionStorage.setItem('preventBackToLogin_landlord', 'true');
    ...
    const isAuthenticated = sessionStorage.getItem('preventBackToLogin_landlord') === 'true' ||
                            window.location.pathname.includes('/landlord/account');
    ...
    if (isAuthenticated) {
        ...
        window.addEventListener('beforeunload', function() {
            ...
            if (!isLoggingOut) {
                sessionStorage.removeItem('preventBackToLogin_landlord');
