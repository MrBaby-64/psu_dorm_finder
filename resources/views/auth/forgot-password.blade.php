<x-guest-layout>
    <!-- Ensure proper layout and no scrolling issues -->
    ...
    <div class="mb-6 text-sm text-gray-600">
        {{ __('Forgot your password? No problem. Enter your email address below and we will send you a password reset link that will allow you to choose a new one.') }}
    </div>
