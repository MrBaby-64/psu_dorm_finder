...
<div class="min-h-screen py-8">
    <div class="max-w-5xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-8">
            <a href="{{ route('favorites.index') }}" class="bg-white rounded-lg shadow-sm p-6 block hover:shadow-lg transition-all duration-200 group fade-in-up">
            ...
            <a href="{{ route('tenant.scheduled-visits') }}" class="bg-white rounded-lg shadow-sm p-6 block hover:shadow-lg transition-all duration-200 group fade-in-up">
                <div class="flex items-center">
            ...
            <a href="{{ route('tenant.reviews') }}" class="bg-white rounded-lg shadow-sm p-6 block hover:shadow-lg transition-all duration-200 group fade-in-up">
                <div class="flex items-center">
            ...
            <a href="{{ route('bookings.index') }}" class="bg-white rounded-lg shadow-sm p-6 block hover:shadow-lg transition-all duration-200 group fade-in-up">
                <div class="flex items-center">
            ...
            <a href="{{ route('tenant.notifications') }}" class="bg-white rounded-lg shadow-sm p-6 block hover:shadow-lg transition-all duration-200 group fade-in-up">
                <div class="flex items-center">
